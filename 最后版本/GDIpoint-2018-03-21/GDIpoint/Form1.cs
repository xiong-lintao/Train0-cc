...
namespace GDIpoint
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            comboBox2.Items.Add(new Space() { Multiple = 20, Name = "200" });
        ...
        public double[] downtimes;
        public double spaceExtra;
        public double proportionY;
        public int mulit;
        public int Xview;
        public int sLength;
        public bool flag = true;//用来选择加哪一个时间
        float X, Y;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            PointF endPointX = new PointF(800, y);
            PointF endPointY = new PointF(80, 20);
            PointF endPointXtop = new PointF(780, y - 10);
            PointF endPointXbottom = new PointF(780, y + 10);
            ...
            for (int i = 1; i <= sLength-2; i++)
            {
                ...
                X = (float)(sumX * 40/ (mulit * int.Parse(infoX[0])) + 80);
